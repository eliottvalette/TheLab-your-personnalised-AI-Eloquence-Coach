...
export default async function freeApi(params){
    ...
    if (language === "fr"){
            ...
            messages: [
                ...
                [Fournis un résumé concis de 2500 charactères environ, en plusieurs paragraphes balisés<p></p> reprenant les éléments essentiels de la discussion, les conclusions tirées et les actions à entreprendre. Fais en sorte que ce résumé soit clair et structuré pour une lecture rapide.]
